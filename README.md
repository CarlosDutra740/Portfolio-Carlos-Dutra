...
## Skills
- **BIM Modeling**: Revit, Autocad, Civil3D, Fusion
...
- Developed an intelligent energy optimization framework combining IoT sensors, data modeling and machine learning to reduce peak loads and improve power distribution efficiency in real time.
    

#### **Automated Industrial Process**

- Designed and deployed a PLC-based automation architecture integrating SCADA, real-time monitoring and deterministic controls to streamline industrial workflows and cut operational overhead.
    

#### **Predictive Maintenance System**

- Implemented a predictive maintenance pipeline using supervised learning models and equipment telemetry to detect failure signatures and extend asset lifecycle in manufacturing environments.
    

---

### **BIM, Digital Twin & Integrated Information Modeling**

#### **BIM Automation & Interoperability Framework**

- Built scalable Revit/Dynamo automation pipelines to eliminate manual tasks, enforce modeling standards and synchronize multidisciplinary models, significantly reducing rework and coordination time.
    
- Created custom Dynamo scripts for model validation, geometry cleanup, parametric standardization and automated documentation.
    

#### **Digital Twin Data Architecture**

- Designed a Digital Twin methodology inspired by IFC structures to unify physical, operational and financial data of systems and assets.
    
- Developed templates and ontologies to support lifecycle tracking, georeferencing, version control and integration with real-world telemetry.
    
- Established Git-based repositories to treat BIM and Digital Twin assets as programmable, auditable systems.
    

#### **Multidisciplinary BIM Coordination System**

- Led the integration of architectural, civil, electrical (power & control), fire protection and mechanical models into a synchronized environment with rules for clash detection, automatic reporting and standardized templates.
    
- Implemented workflows that improved interoperability across teams and increased model reliability for downstream engineering.
...
- Designed and printed parametric components to validate form, fit and assembly before construction or manufacturing.
    
- Developed workflows connecting BIM geometries with slicer-ready mesh preparation, ensuring dimensional accuracy and reducing fabrication iterations.
    

#### **Furniture & Joinery Modeling in Revit**

- Produced fully parametric joinery libraries with automated fabrication sheets, cut lists and nesting preparation.
    
- Integrated design-to-fabrication logic enabling consistent outputs for workshops and CNC workflows.
## Languages
- **Portuguese**: Native
- **English**: Advanced
